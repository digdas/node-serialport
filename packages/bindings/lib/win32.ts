...
import { AbstractBinding, PortInfo, GetFlags, UpdateOptions } from '@serialport/binding-abstract'
...
const setAsync = promisify(windowsBinding.set) as (fd: number, opts: SetFlags) => Promise<void>
